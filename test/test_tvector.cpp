...
// Данные переносятся правильно
TEST(TDynamicVector, data_is_correct_after_moving_data_with_constructor)
{
	TDynamicVector<int> v1(10);
...
// Изначальный вектор пустой после перемещения
...
// Данные переносятся правильно
TEST(TDynamicVector, data_is_correct_after_moving_data_with_operator)
{
	TDynamicVector<int> v1(10);
